...
route.post('/register', (req, res)=>{
    ...
    if(password.length < 8) errors.push({msg: "Password length should be at least 8 characters"});

    //What if user already exist

    if(errors.length > 0){ //If there are issues with the form, reject the form and re-render it with user values
